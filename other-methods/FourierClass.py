...
def header():
	...
	dataset.write("nameseq,faverage,fmedian,fmaximum,fminimum,fpeak,"
                  + "fnone_levated_peak,fsample_standard_deviation,fpopulation_standard_deviation,"
                  + "fpercentile15,fpercentile25,fpercentile50,fpercentile75,famplitude,"
                  + "fvariance,finterquartile_range,fsemi_interquartile_range,"
                  + "fcoefficient_of_variation,fskewness,fkurtosis,label")
	dataset.write("\n")
	return
